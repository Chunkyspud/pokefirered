...
void ChangePokemonNicknamePartyScreen_CB(void)
{
...
static void ChangePokemonNicknamePartyScreen(void)
{
    ...
    DoNamingScreen(NAMING_SCREEN_CAUGHT_MON, gStringVar2, GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_SPECIES, NULL), GetMonGender(&gPlayerParty[gSpecialVar_0x8004]), GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_PERSONALITY, NULL), ChangePokemonNicknamePartyScreen_CB);
}
static void CursorCB_Nickname(u8 taskId)
{
    PlaySE(SE_SELECT);
